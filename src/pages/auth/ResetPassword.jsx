          ...
          <div className="w-full lg:w-1/2 bg-[#94CDFA] p-5 md:px-18 md:py-28 shadow-[0px_10px_20px_rgba(0,0,0,0.2)] rounded-2xl">
            ...
            <form className="space-y-6">
              <div className="w-full">
                <label className="text-xl text-[#000] mb-2 font-bold">
                  New Password
                </label>
                <div className="w-full relative">
                  <input
                    ...
                    name="password"
                    placeholder="**********"
                    className="w-full px-5 py-3 border-2 border-[#000] rounded-md outline-none mt-5 placeholder:text-xl"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="w-full">
                ...
                <div className="w-full relative">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 bottom-4 flex items-center text-[#000]"
                  >
                    {showPassword ? (
                      <IoEyeOffOutline className="w-5 h-5" />
                    ) : (
