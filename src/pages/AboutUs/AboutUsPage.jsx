...
function AboutUs() {
    ...
    return (
        <div>
            <div className="bg-[#94CDFA] px-5 py-3 rounded-md mb-3 flex items-center gap-3">
                <button
                    onClick={() => navigate(-1)}
            ...
            <div className="text-center py-5">
                <button
                    ...
                    className="bg-[#94CDFA] text-white font-semibold w-full py-2 rounded transition duration-200"
                >
                    Save changes
                </button>
            </div>
